...
public enum RetCode {
        ...
        VALIDATEFAIL("-106","验证失败"),
        COMMITDUP("-107","重复提交"),
        RELEASEDUP("-108","重放"),
        DECRYPTEXCEP("-109","解密异常"),
        ENCRYPTEXCEP("-110","加密异常"),
        SHOWCAPTCHA("-111","显示图形验证码"),
        CAPTCHAERR("-112","图形验证码输入有误"),
        DENYFORMORE("-113","请求次数超限，操作被拒绝"),
        NOPERMISSION("-114","权限不足"),
        GOMEBINDFAIL("-120","Gome用户绑定失败"),

        NOACCOUNTINFO("-101","未查到账户信息"),
		NOUSERINVESTSURVER("-111","未查到用户风险评估信息"),
		NOPAYPASSWORD("-201","未设置交易密码"),
        EMPTYPAYPASSWORD("-202","用户交易密码为空"),
//        CONSUMPWDONEERR("-203","交易密码输错1次"),
//        CONSUMPWDTWOERR("-204","交易密码输错2次"),
//        USERLOCKED("-205","账户被锁定"),
//        LOCKEDPLEASE("-206","账号已锁定，12小时后自动解锁立即解锁，请联系客服：400-0666-088\n"),
        ...
        BALANCEINSUFFICIENT("-1001","账户余额不足"),
        NOTBINDCARD("-1002","用户未开户"),
        CREDITLINEINSUFFICIENT("-2001","授信额度不足"),
        LEVELLOW("-2002","用户等级不足"),
